...
class AnchorHeadDFDRTemplate(nn.Module):
    ...
    def get_box_reg_layer_adaptive_loss(self):
        ...
        # print(self.model_cfg.LOSS_CONFIG.LOSS_WEIGHTS['im_weight'])
        loc_loss_src = loc_loss_src * importance - self.model_cfg.LOSS_CONFIG.LOSS_WEIGHTS['im_weight'] * (importance - 0.5) * (importance - 0.5)
